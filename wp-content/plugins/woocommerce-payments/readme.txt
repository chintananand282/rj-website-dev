...
= 5.4.1 - 2023-03-23 =
* Update - Security update. tooltip.
...
= 5.4.1 - 2023-03-23 =
* Update - Security update. delete related `add_actions()` in the `WC_Subscriptions_Manager` class to be added on the `woocommerce_loaded` action.
