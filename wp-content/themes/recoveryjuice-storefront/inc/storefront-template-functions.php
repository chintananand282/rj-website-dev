...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		...
		<div class="site-info">
			...
			<div class="site-copyright_text">
				<?php echo esc_html( apply_filters( 'storefront_copyright_text', $content = 'Copyright &copy;'. ' ' . gmdate( 'Y' ) . ' '. $content = 'Recovery Juice | All Rights Reserved') ); ?>
			</div>
...
if ( ! function_exists( 'storefront_page_header' ) ) {
	...
	function storefront_page_header() {
		if ( ( is_front_page() && is_page_template( 'template-fullwidth.php' ) ) || is_front_page()) {
			return;
		}
